...
class LeadFactoryService(BaseAssistantService):
    ...
    def run(self, payload: AssistantRequest) -> AssistantResponse:
        ...
        business_name = business.business_name.strip() or "la tua attività"
        ...
        summary = (
            ...
            f" Strategia pensata per vendere più velocemente a {location}."
        )
        ...
        output = (
            ...
            f"Ciao, lavoro con realtà come {business_name} e sto aiutando aziende di {sector} "
